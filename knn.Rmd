...
```{r nb_sanity}
truth <- count(employee_data,vars=Attrition)
...
max accuracy is at `r max_acc_k`

we choose `r chosen_k` as best overall, because the sensitivity stops increasing at that point.
...
predicted_attrition <- knn(for_knn[,cols_for_knn],
