...
myfun <- function(varname,fptr=noop)
{
...
myfun('Age')
myfun('DistanceFromHome',sqrt)
myfun('MonthlyIncome',log)
myfun('YearsAtCompany',sqrt)
myfun('YearsSinceLastPromotion',sqrt)
myfun('YearsWithCurrManager',sqrt)
myfun('WorkLifeBalance')
myfun('TotalWorkingYears',sqrt)
